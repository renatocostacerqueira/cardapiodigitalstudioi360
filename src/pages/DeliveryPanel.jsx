...
import { Truck, Phone, MapPin, CreditCard, Clock, ArrowLeft, User, StickyNote, RefreshCw, AlertCircle } from 'lucide-react';
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div className="info-row">
                    ...
                    <div>
                      ...
                      <div className="info-value" style={{ fontSize: 16, color: 'var(--purple-600)' }}>
                        <a href={`tel:${order.customer_phone}`} style={{ color: 'inherit', textDecoration: 'none' }}>
